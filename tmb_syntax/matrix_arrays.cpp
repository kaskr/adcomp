...
Type objective_function<Type>::operator() ()
{
  ...
  vector<Type> v_concat_v1_v2(v1.size()+v2.size()); // concatination of v1 and v2
  v_concat_v1_v2 << v1,v2;              // Syntax for concatination. Left hand hand must be allocated/exist (line above)
